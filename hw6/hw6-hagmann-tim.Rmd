...
As can be seen above, the *network-count.py* script appears to be working. Next we're moving to the *network-count-structured.py*.
...
The *network-count-structured.py* is also working. 
...
rm -r /home/tim/e63-coursework/hw6/data/output/*
rm /home/tim/chunk*
...
```{bash eval=FALSE}
spark-submit --master local[2] /home/tim/e63-coursework/hw6/scripts/count-buys3.py
```
...
Next we're rewriting the the script. 
```{bash eval=FALSE}
