...
The *network-count-structured.py* is also working. It is running in batches and splits the analysis before giving us the final output in *batch 2*.
...
# Start docker
docker run --hostname=quickstart.cloudera --privileged=true -it --rm -i -t -p 8888:8888 -p 80:80 -p 7180:7180 -p 7077:7077 -p 7078:7078 -p 8080:8080 -p 18080:18080 -p 18081:18081 -p 8020:8020 cloudera/quickstart /usr/bin/docker-quickstart
```
...
4b36e5f065e3        cloudera/quickstart   "/usr/bin/docker-q..."   2 minutes ago
...
docker exec -it --user root 4b36e5f065e3 bash
```
...
### iii) Setup Image
Before beeing able to start with the analysis we have to setupt the docker environment variables.
```{bash eval=FALSE}
...
```
The is nothing in the staging folder.
...
The SLF4J error can be ignored. The output files also look good. However, if the number of standard deviations by which a task's average progress-rates is lower than the average of all running tasks the so called *race condition* is appearing. That means that by copying directly from the local file system to the hadoop *input* directory, there are cases where Spark tries to read the file just after it's name was changes. This leads to files named chunkaa._COPYING_". When the file is finished copying, the extension is changed. If Spark now sees the new temp file and then tries to read it just after its name was changed, it causes a *file not found error* and the scripts exits. That means that once one of the two tasks finishes successfully, the other task is killed.

### vi) Eliminate race condition
Then run script *splitAndSend.sh* and Python program *count-buys.py* and tell us what the results are. In both cases show use contents of your HDFS directories input, output and staging. The second script *splitAndSend.sh* is supposed to reduce or eliminate the race condition.
...
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:12 output/output-1507929162000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929162000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929162000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:12 output/output-1507929165000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929165000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929165000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:12 output/output-1507929168000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929168000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera         29 2017-10-13 21:12 output/output-1507929168000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:12 output/output-1507929171000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929171000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929171000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:12 output/output-1507929174000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929174000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929174000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:12 output/output-1507929177000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:12 output/output-1507929177000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera         29 2017-10-13 21:12 output/output-1507929177000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929180000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929180000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929180000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929183000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929183000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929183000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929186000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929186000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera         29 2017-10-13 21:13 output/output-1507929186000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929189000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929189000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929189000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929192000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929192000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929192000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929195000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929195000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929195000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929198000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929198000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera         29 2017-10-13 21:13 output/output-1507929198000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929201000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929201000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929201000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929204000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929204000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929204000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929207000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929207000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera         29 2017-10-13 21:13 output/output-1507929207000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929210000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929210000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929210000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929213000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929213000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929213000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929216000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929216000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929216000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929219000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929219000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929219000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929222000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929222000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929222000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929225000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929225000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929225000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929228000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929228000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929228000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929231000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929231000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929231000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929234000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929234000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera         29 2017-10-13 21:13 output/output-1507929234000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:13 output/output-1507929237000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929237000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:13 output/output-1507929237000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:14 output/output-1507929240000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:14 output/output-1507929240000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:14 output/output-1507929240000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:14 output/output-1507929243000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:14 output/output-1507929243000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:14 output/output-1507929243000.txt/part-00000
drwxr-xr-x   - cloudera cloudera          0 2017-10-13 21:14 output/output-1507929246000.txt
-rw-r--r--   1 cloudera cloudera          0 2017-10-13 21:14 output/output-1507929246000.txt/_SUCCESS
-rw-r--r--   1 cloudera cloudera         29 2017-10-13 21:14 output/output-1507929246000.txt/part-00000
...
That means there were 5124 buys and 4876 sells in that particualar 3 second interval. 
